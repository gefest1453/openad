...
const ISA_REGISTER_CLASS_INFO ISA_REGISTER_CLASS_info[] = {
  ...
  { 0x01,   0, 127, 64, 0, 0, "application",
    { "ar.k0", "ar.k1", "ar.k2", "ar.k3", "ar.k4", "ar.k5", "ar.k6", "ar.k7", "ar8", "ar9", "ar10", "ar11", "ar12", 
      "ar13", "ar14", "ar15", "ar.rsc", "ar.bsp", "ar.bspstore", "ar.rnat", "ar20", "ar.fcr", "ar22", "ar23", 
      "ar,eflag", "ar.csd", "ar.ssd", "ar.cflg", "ar.fsr", "ar.fir", "ar.fdr", "ar31", "ar.ccv", "ar33", "ar34", "ar35", 
      "ar.unat", "ar37", "ar38", "ar39", "ar.fpsr", "ar41", "ar42", "ar43", "ar.itc", "ar45", 
      "ar46", "ar47", "ar48", "ar49", "ar50", "ar51", "ar52", "ar53", 
      "ar54", "ar55", "ar56", "ar57", "ar58", "ar59", "ar60", "ar61", 
      "ar62", "ar63", "ar.pfs", "ar.lc", "ar.ec", "ar67", "ar68", "ar69", "ar70", "ar71", 
  ...
  { 0x01,   0, 127, 64, 0, 0, "control",
    { "cr.dcr", "cr.itm", "cr.iva", "cr3", "cr4", "cr5", "cr6", "cr7", "cr.pta", "cr9", "cr10", 
      ...
      "cr.itir", "cr.iipa", "cr.ifs", "cr.iim", "cr.iha", "cr26", "cr27", "cr28", "cr29", "cr30", "cr31", 
      ...
      "cr.lid", "cr.ivr", "cr.tpr", "cr.eoi", "cr.irr0", "cr.irr1", "cr.irr2", "cr.irr3", "cr.itv", "cr.pmv", "cr.cmcv", "cr75", "cr76", "cr77", 
      "cr78", "cr79", "cr.lrr0", "cr.lrr1", "cr82", "cr83", "cr84", "cr85", "cr86", 
      "cr87", "cr88", "cr89", "cr90", "cr91", "cr92", "cr93", "cr94", 
      "cr95", "cr96", "cr97", "cr98", "cr99", "cr100", "cr101", "cr102", 
      "cr103", "cr104", "cr105", "cr106", "cr107", "cr108", "cr109", "cr110", 
      "cr111", "cr112", "cr113", "cr114", "cr115", "cr116", "cr117", "cr118", 
      "cr119", "cr120", "cr121", "cr122", "cr123", "cr124", "cr125", "cr126", 
      "cr127" } },
};
