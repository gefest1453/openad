...
const ISA_OPERAND_INFO ISA_OPERAND_info[] = {
  ...
  { 6, {   7,  22,  16,   9,   9,  30 },          /* O_126 */
       {   1,   0,   0,   3,   6,   4 },          /* O_126 */
    1, {   9,  -1,  -1 } },                       /* O_126 */
  { 3, {   7,   9,  36,  -1,  -1,  -1 },          /* O_spadjust */
       {   1,   7,   8,   0,   0,   0 },          /* O_spadjust */
    1, {   9,  -1,  -1 } },                       /* O_spadjust */
  { 2, {   9,  32,  -1,  -1,  -1,  -1 },          /* O_noop_pregtn */
       {   0,   0,   0,   0,   0,   0 },          /* O_noop_pregtn */
    0, {  -1,  -1,  -1 } },                       /* O_noop_pregtn */
  { 1, {  36,  -1,  -1,  -1,  -1,  -1 },          /* O_intrncall */
       {   0,   0,   0,   0,   0,   0 },          /* O_intrncall */
    1, {   9,  -1,  -1 } },                       /* O_intrncall */
  { 0, {  -1,  -1,  -1,  -1,  -1,  -1 },          /* O_noop_ifixup */
       {   0,   0,   0,   0,   0,   0 },          /* O_noop_ifixup */
    1, {   9,  -1,  -1 } },                       /* O_noop_ifixup */
  { 0, {  -1,  -1,  -1,  -1,  -1,  -1 },          /* O_noop_ffixup */
       {   0,   0,   0,   0,   0,   0 },          /* O_noop_ffixup */
    1, {   8,  -1,  -1 } },                       /* O_noop_ffixup */
  { 0, {  -1,  -1,  -1,  -1,  -1,  -1 },          /* O_noop */
       {   0,   0,   0,   0,   0,   0 },          /* O_noop */
    0, {  -1,  -1,  -1 } },                       /* O_noop */
  { 2, {   7,   6,  -1,  -1,  -1,  -1 },          /* O_copy_br */
       {   0,   0,   0,   0,   0,   0 },          /* O_copy_br */
    1, {   6,  -1,  -1 } },                       /* O_copy_br */
  { 0, {  -1,  -1,  -1,  -1,  -1,  -1 },          /* O_asm */
       {   0,   0,   0,   0,   0,   0 },          /* O_asm */
    0, {  -1,  -1,  -1 } },                       /* O_asm */
  { 1, {  49,  -1,  -1,  -1,  -1,  -1 },          /* O_label */
       {   0,   0,   0,   0,   0,   0 },          /* O_label */
    0, {  -1,  -1,  -1 } },                       /* O_label */
};
...
const mUINT8 ISA_OPERAND_info_index[] = {
  ...
  101,  /* xma.lu: O_101 */
   ...
   23,  /* mov_t_ar_i: O_23 */
    8,  /* nop: O_8 */
  134,  /* asm: O_asm */
  129,  /* intrncall: O_intrncall */
  127,  /* spadjust: O_spadjust */
  133,  /* copy.br: O_copy_br */
  128,  /* begin.pregtn: O_noop_pregtn */
  128,  /* end.pregtn: O_noop_pregtn */
  132,  /* bwd.bar: O_noop */
  132,  /* fwd.bar: O_noop */
  131,  /* dfixup: O_noop_ffixup */
  131,  /* ffixup: O_noop_ffixup */
  130,  /* ifixup: O_noop_ifixup */
  135,  /* label: O_label */
  132,  /* noop: O_noop */
};
